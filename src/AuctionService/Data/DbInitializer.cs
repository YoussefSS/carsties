...
public class DbInitializer
{
    ...
    {
        // We use the using keyword to dispose of anything we use throughout this method
    ...
    {
        // Applies any pending migrations to the database. Will create the database if it does not already exist.
        // Similar to the "dotnet ef database update" command
        ...
        // Done in memory, we need to call SaveChanges to actually apply this change to our DB
